...
const CardOnField = ({ 
    ...
    // --- All your existing droppable logic remains UNCHANGED ---
    ...
    // ${isInvalidDrop ? 'ring-4 ring-red-500' : ''}

    return (
        <div
            ref={setNodeRef} // The droppable ref remains here
        ...
        >
            ...
            {/* --- NEW: The Contextual Action Menu --- */}
